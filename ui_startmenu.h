...
public:
    ...
    QPushButton *againstEasyAndroid;
    ...
    QPushButton *againstHardAndroid;
...
"		"));
        ...
        againstEasyAndroid = new QPushButton(StartMenu);
        againstEasyAndroid->setObjectName(QStringLiteral("againstEasyAndroid"));
        againstEasyAndroid->setStyleSheet(QLatin1String("QPushButton {		    \n"
"             color: white;\n"
...
"         }"));
        ...
        gridLayout->addWidget(againstEasyAndroid, 8, 1, 1, 1);
...
"         }"));
        ...
        gridLayout->addWidget(exitButton, 12, 1, 1, 1);
...
"         }"));
        ...
        gridLayout->addWidget(changePlayer, 10, 1, 1, 1);
...
"}"));
        ...
        againstHardAndroid = new QPushButton(StartMenu);
        againstHardAndroid->setObjectName(QStringLiteral("againstHardAndroid"));
        againstHardAndroid->setStyleSheet(QLatin1String("QPushButton {		    \n"
"             color: white;\n"
"             background-color: rgb(0, 120, 150);\n"
"             border-radius: 20px;	\n"
"             border-top: 20px transparent;\n"
...
"         }"));
    ...
    void retranslateUi(QWidget *StartMenu)
    {
        ...
        againstEasyAndroid->setText(QApplication::translate("StartMenu", "Play Against Android (easy)", 0));
        ...
        startGameButton->setText(QApplication::translate("StartMenu", "Play with yourself", 0));
        againstHardAndroid->setText(QApplication::translate("StartMenu", "Play Against Android (hard)", 0));
    } // retranslateUi
